...
func NewServer() (*Server, error) {
	...
	profilerConfig := configs.NewProfilerConfig(configurator)
	...
	server := NewApp(appConfig, loggerConfig, profilerConfig, configurator, errorsHandler, privateRouter, publicRouter, swaggerRouter)
	return server, nil
}
